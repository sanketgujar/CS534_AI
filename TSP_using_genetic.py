...
def genetic_algorithm(population, fitness_fn, ngen=1000000 , pmut=0.1 , gene_pool=[0, 1], f_thres=None  ):  # noqa
    for i in range(ngen):
        new_population = []
...
if __name__ == '__main__':
    prob =Problem(8)
    print ( genetic_search(prob,fitness_fn) )
